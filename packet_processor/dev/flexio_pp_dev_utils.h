...
/*
sch starts without work-conserving rollover, then enables it after this many
seconds of scheduler runtime.
*/
#define SCH_ROLLOVER_WORK_CONSERVING_SWITCH_SEC 10
...
struct dpa_sche_context {
	...
	uint8_t rollover_work_conserving;
	size_t rollover_work_conserving_switch_cycle;
