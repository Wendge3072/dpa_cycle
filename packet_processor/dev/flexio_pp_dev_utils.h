...
#ifndef WORKER_QUEUE_BURST_REPORT
#define WORKER_QUEUE_BURST_REPORT 1
#endif
...
struct dpa_thread_context {
	...
	size_t queue_burst_sum[WORKER_QUEUES_PER_THREAD];
	size_t queue_poll_count[WORKER_QUEUES_PER_THREAD];
#endif
